...
public class Drive extends Subsystem {
    ...
    // Hardware
    private final CANTalon mLeftMaster, mRightMaster, mLeftSlave, mRightSlave, mLeftSlave1, mRightSlave1;
    ...
    private Drive() {
        ...
        mLeftSlave1 = CANTalonFactory.createPermanentSlaveTalon(Constants.kLeftDriveSlaveId,
                Constants.kLeftDriveMasterId);
        mLeftSlave.reverseOutput(false);
        mLeftSlave1.reverseOutput(false);
        ...
        mRightSlave1 = CANTalonFactory.createPermanentSlaveTalon(Constants.kRightDriverSlaveId,
                Constants.kRightDriveMasterId);
        mRightSlave.reverseOutput(false);
        mRightSlave1.reverseOutput(false);
    ...
    public synchronized void setBrakeMode(boolean on) {
        if (mIsBrakeMode != on) {
            ...
            mRightSlave1.enableBrakeMode(on);
            
            mLeftMaster.enableBrakeMode(on);
            mLeftSlave.enableBrakeMode(on);
            mLeftSlave1.enableBrakeMode(on);
        }
    }
    ...
    public boolean checkSystem() {
        ...
        mRightSlave1.changeControlMode(CANTalon.TalonControlMode.Voltage);
        ...
        mRightSlave1.changeControlMode(CANTalon.TalonControlMode.Follower);
        mRightSlave1.set(Constants.kRightDriveMasterId);
        ...
        mLeftSlave1.set(Constants.kLeftDriveMasterId);
